              ...
              <div className="flex-col pt-5 flex overflow-y-auto">
                <div className="h-full flex-col justify-between px-4 flex">
                  <div className="space-y-4">
                    ...
                    {/*          17" stroke="#4F4F4F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><svg*/}
                    {/*              x="3" y="3" width="18" height="18" rx="2" stroke="#4F4F4F" strokeWidth="2"></svg>*/}
                    {/*          </span>*/}
                    {/*        </span>*/}
                    {/*      </span>*/}
                    {/*    </span>*/}
                    ...
                    {/*          <span className="items-center justify-center flex">*/}
                    {/*            <svg className="mr-4" width="24" height="24" viewBox="0 0 24 24" fill="none"*/}
                    {/*              xmlns="http://www.w3.org/2000/svg" /><path d="M8 10L8 16" stroke="#4F4F4F" strokeWidth="2"*/}
                    {/*                strokeLinecap="round" strokeLinejoin="round" /><path d="M12 12V16" stroke="#4F4F4F"*/}
                    {/*                  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><path d="M16 8V16"*/}
                    {/*                    stroke="#4F4F4F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><svg*/}
                    {/*                      x="3" y="4" width="18" height="16" rx="2" stroke="#4F4F4F" strokeWidth="2"></svg>*/}
                    {/*          </span>*/}
                    {/*        </span>*/}
                    {/*      </span>*/}
                    {/*    </span>*/}
                    ...
                    {/*                  stroke="#4F4F4F" strokeWidth="2" /></svg>*/}
                    {/*            </span>*/}
                    {/*          </span>*/}
                    {/*        </span>*/}
                    {/*      </span>*/}
                    ...
                    {/*                stroke="#4F4F4F" strokeWidth="2" strokeLinecap="round" /><path d="M13 9L12 3"*/}
                    {/*                  stroke="#4F4F4F" strokeWidth="2" strokeLinecap="round" /><path d="M12.5 21H11.5"*/}
                    {/*                    stroke="#4F4F4F" strokeWidth="2" strokeLinecap="round" />*/}
                    {/*            </span>*/}
                    {/*          </span>*/}
                    {/*        </span>*/}
                    {/*      </span>*/}
                    ...
                    {/*              <svg className="flex-shrink-0 w-5 h-5 mr-4" xmlns="http://www.w3.org/2000/svg" fill="none"*/}
                    {/*                viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round"*/}
                    {/*                  strokeLinejoin="round" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2*/}
                    ...
                    <div>
                      ...
                      <div className="mt-4 bg-top bg-cover space-y-1">
                        <a href="/#about" className="font-medium text-sm items-center rounded-lg text-gray-900 px-4 py-2.5 flex
                          transition-all duration-200 hover:bg-gray-200 group cursor-pointer">
                          <span className="justify-center items-center flex">
                            <span className="justify-center items-center flex">
                              <span className="justify-center items-center flex">
                                <span className="items-center justify-center flex">
                                  <svg className="flex-shrink-0 w-5 h-5 mr-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" /><path strokeLinecap="round"
                                      strokeLinejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0
                        ...
                        <a href="/#contact" className="font-medium text-sm items-center rounded-lg text-gray-900 px-4 py-2.5 flex
                          transition-all duration-200 hover:bg-gray-200 group cursor-pointer">
                          <span className="justify-center items-center flex">
                            <span className="justify-center items-center flex">
                              <span className="justify-center items-center flex">
                  ...
                  {/*              <svg className="flex-shrink-0 w-5 h-5 mr-4" xmlns="http://www.w3.org/2000/svg" fill="none"*/}
                  {/*                viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" /><path strokeLinecap="round"*/}
                  {/*                  strokeLinejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0*/}
                  ...
                  {/*                strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016*/}
                  {/*            0z"/>*/}
                  {/*            </span>*/}
                  {/*          </span>*/}
                  {/*        </span>*/}
                  ...
                  {/*            5.0718" stroke="#4F4F4F" strokeWidth="2" /><path d="M2 12L1.21913 11.3753L0.719375*/}
